    ...
    <section id="lieu" className="relative bg-white px-6 py-16 md:py-24 text-center scroll-mt-6 overflow-hidden">
      ...
      <Reveal>
        ...
        <div className="max-w-xs sm:max-w-sm md:max-w-xl mx-auto">
          <p className="font-display italic text-xl md:text-3xl text-cocoa mb-2 md:mb-3">Terre Rouge</p>
          <p className="text-sm md:text-base uppercase tracking-widest text-cocoa-light mb-6 md:mb-8">Yaoundé, Cameroun</p>
          <p className="text-sm md:text-lg text-cocoa-light leading-relaxed mb-8 md:mb-10">
